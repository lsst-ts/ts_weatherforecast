...
.. image:: https://img.shields.io/badge/SAL-API-gray.svg
    :target: https://ts-xml.lsst.io/sal_interfaces/WeatherForecast.html
.. image:: https://img.shields.io/badge/GitHub-gray.svg
    :target: https://github.com/lsst-ts/ts_weatherforecast
.. image:: https://img.shields.io/badge/Jira-gray.svg
    :target: https://jira.lsstcorp.org/issues/?jql=labels+%3D+ts_weatherforecast
.. image:: https://img.shields.io/badge/Jenkins-gray.svg
    :target: https://tssw-ci.lsst.org/job/LSST_Telescope-and-Site/job/ts_weatherforecast/
...
.. note:: If you are interested in viewing other branches of this repository append a `/v` to the end of the url link. For example `https://ts_weatherforecast.lsst.io/v/`
...
User-level documentation, found at the link below, is aimed at personnel looking to perform the standard use-cases/operations with the WeatherForecast.
...
Configuring the WeatherForecast
=========================================
...
The configuration for the WeatherForecast is described at the following link.
...
This area of documentation focuses on the classes used, API's, and how to participate to the development of the WeatherForecast software packages.
...
The version history of the WeatherForecast is found at the following link.
